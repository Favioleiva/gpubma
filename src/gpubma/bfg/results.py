...
class BFGResult:
    ...
    sign_probability : pd.Series
        Integration weight of models with positive conditional coefficient means.
        This historical point-sign summary is not integrated P(beta_j > 0 | y).
    map_model : List[str]
    ...
    def backend(self) -> str:
        """Name of execution backend engine ('legacy' for p <= 60)."""
        return "legacy"
    ...
    def summary(self) -> str:
        ...
        lines = [
            ...
            f"Best-found MAP Model ID:   {self.map_model_id} (Size {len(self.map_model)})",
