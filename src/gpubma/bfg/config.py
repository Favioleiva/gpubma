...
class BFGConfig:
    ...
    checkpoints : Optional[List[int]], default=None
        Evaluation thresholds requesting a save at the next completed resumable
        phase/lattice boundary. A batch/phase can cross more than one threshold.
        With a checkpoint directory and no list, every completed boundary saves.
